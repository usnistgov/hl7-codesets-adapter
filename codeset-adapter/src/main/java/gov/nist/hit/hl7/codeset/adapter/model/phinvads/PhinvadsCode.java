...
public class PhinvadsCode implements Serializable {
    /**
     *
     */
    ...
    public PhinvadsCode(String value, String description, String codeSystem, String comments) {
        this.setId(new ObjectId().toString());
        this.value = value;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        PhinvadsCode other = (PhinvadsCode) obj;
        if (codeSystem == null) {
